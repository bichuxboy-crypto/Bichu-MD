/**
   * Create By BICHUXZUBIII-MD 
   * Contact Me on 923496633707
*/
...
const initializeBot = async () => {
    console.clear();
    console.log(chalk.cyan(figlet.textSync('BICHUXZUBAIR-MD', {
        font: 'Standard',
    ...
    console.log(chalk.green('   BICHUXZUBAIR-MD 𝐩𝐚𝐢𝐫𝐢𝐧𝐠 𝐬𝐲𝐬𝐭𝐞𝐦       '));
    console.log(chalk.yellow('═══════════════════════════════════════════════\n'));
...
function launchBot() {
    console.clear();
    console.log(chalk.green('🚀 Starting BICHUXZUBAIR-MD system...\n'));
    ...
    if (fs.existsSync(botPath)) {
        try {
            ...
            require('./bot');
            telegramLoaded = true;
            console.log(chalk.green('✅BICHUXZUBAIR-MD bot loaded successfully!'));
        } catch (error) {
    ...
    console.log(chalk.bold.white('BICHUXZUBAIR-MD BOT INITIALIZATION SUMMARY          '));
    console.log(chalk.cyan('═══════════════════════════════════════════════'));
    console.log(telegramLoaded ? chalk.green('✅BICHUXZUBAIR-MD тɛℓɛɢяαм вσт: Active') : chalk.red('❌BICHUXZUBAIR-MD тɛℓɛɢяαм вσт : Inactive'));
    ...
    if (!telegramLoaded && !whatsappLoaded) {
        ...
        console.log(chalk.green('✅ BICHUXZUBAIR-MD system is ready and running!\n'));
    }
